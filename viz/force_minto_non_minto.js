...
d3.json("force2.json", function(json) {
  ...
  function linkcolortimeclass(d) {
    var scale = d3.scale.category10()
        .domain(['Direct Transmission', 'Environmental Persistence'])
    return scale(d.tr_timeclass)
  }

  function nodecoloralaska(d) {
  	var scale = d3.scale.category10()
  		.domain(['Alaska'])
